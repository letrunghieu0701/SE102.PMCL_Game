...
#define TEXTURE_PATH_FIRST_WORLD_1_1 "\\NES - Super Mario Bros 3 - Stage Tiles.png"
//#define world_1_1 TEXTURES_DIR "\\"

CMario *mario;
#define MARIO_START_X 30.0f
#define MARIO_START_Y 320.0f - 28 + 8
...
void LoadResources()
{
	...
	/*textures->Add(ID_TEX_ENEMY, TEXTURE_PATH_ENEMIES, D3DCOLOR_XRGB(156, 219, 239));*/
	...
	goomba = new CGoomba(MARIO_START_X + 20, MARIO_START_Y + 20, MARIO_START_VX);
