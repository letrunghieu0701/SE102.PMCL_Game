...
#define MARIO_SPEED_MAX_FALL_DOWN_Y	0.3f

// Raccon khi rơi chậm
// Phản lực theo trục y, để rơi chậm hơn
#define AIR_FORCE_X						MARIO_WALKING_SPEED / 3
#define MARIO_JET_FORCE_USING_TAIL_Y	0.1f

#define MARIO_SPEED_FALL_SLOW_Y			MARIO_JET_FORCE_USING_TAIL_Y * 0.75f
#define MARIO_SPEED_MAX_FALL_SLOW_X			MARIO_SPEED_FALL_SLOW_Y // MARIO_WALKING_SPEED - AIR_FORCE_X

#define MARIO_GRAVITY_FALL_SLOW_Y		MARIO_GRAVITY * 0.5f
...
#define MARIO_FALL_SLOW_TIME	150
